                ...
                <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                  ...
                  <Tab.Container id="projects-tabs" defaultActiveKey="first">
                    <Nav variant="pills" className="nav-pills mb-5 justify-content-center align-items-center" id="pills-tab">
                      ...
                      <Nav.Item>
                        <Nav.Link eventKey="second">Platform Coordinator</Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link eventKey="third">Systems Administrator</Nav.Link>
                      </Nav.Item>
                    </Nav>
                    <Tab.Content id="slideInUp" className={isVisible ? "animate__animated animate__slideInUp" : ""}>
                      <Tab.Pane eventKey="first">
                        {/* Description for the first tab */}
                      ...
                      <Tab.Pane eventKey="second">
                        <p>
                          ...
                          site security assessments. I coordinate feature and change request 
                          implementations to ensure alignment with asset protection processes, while driving usability, data integrity, and meeting business needs.
                        </p>
                      </Tab.Pane>
